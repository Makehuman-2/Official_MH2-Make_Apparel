...
def extraProperties():
    ...
    if not hasattr(bpy.types.Object, "MhRigid"):
        bpy.types.Object.MhRigid = StringProperty(name="Rigid, connected to", description="Name of the rigid group where it is connected to", default = "not rigid")
