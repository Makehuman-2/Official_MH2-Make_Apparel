...
class MHMat:
    ...
    def __str__(self):
        mat = "# This is a material file for MakeHuman 2, produced by MakeApparel\n"
...
class MHC_OT_ImportMaterialOperator(bpy.types.Operator, ImportHelper):
    """Import MHMAT"""
    bl_idname = "makeapparel.import_material"
...
class MHC_OT_CreateMaterialOperator(bpy.types.Operator):
    ...
    bl_idname = "makeapparel.create_material"
...
class MHC_OT_WriteMaterialOperator(bpy.types.Operator, ExportHelper):
    ...
    bl_idname = "makeapparel.write_material"
